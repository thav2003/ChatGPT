              ...
              >
                <div class="grid w-full grid-flow-row grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-2">
                  <div class="flex flex-col gap-2">
                    <span data-projection-id="45" style="opacity: 1; transform: none"
                      ><button
                        ...
                        <div class="flex w-full gap-2 items-center justify-center">
                          <div class="flex w-full items-center justify-between">
                            <div class="flex flex-col overflow-hidden">
                              <div class="truncate">Show me a code snippet</div>
                              <div class="truncate font-normal opacity-50">of a website's sticky header</div>
                            </div>
                            <div
                            ...
                            >
                              <span class="" data-state="closed"
                                ><div class="rounded-lg bg-white p-1 shadow-xxs dark:shadow-none">
                                  <svg
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                    ...
                    ><span data-projection-id="46" style="opacity: 1; transform: none"
                      ><button
                        class="btn relative btn-neutral group w-full whitespace-nowrap rounded-xl px-4 py-3 text-left text-gray-700 dark:text-gray-300 md:whitespace-normal"
                        as="button"
                      >
                  ...
                  <div class="flex flex-col gap-2">
                    <span data-projection-id="47" style="opacity: 1; transform: none"
                      ><button
                        class="btn relative btn-neutral group w-full whitespace-nowrap rounded-xl px-4 py-3 text-left text-gray-700 dark:text-gray-300 md:whitespace-normal"
                        as="button"
                      >
                        <div class="flex w-full gap-2 items-center justify-center">
                          <div class="flex w-full items-center justify-between">
                            <div class="flex flex-col overflow-hidden">
                              <div class="truncate">Tell me a fun fact</div>
                              <div class="truncate font-normal opacity-50">about the Golden State Warriors</div>
                            </div>
                            <div
                              class="absolute bottom-0 right-0 top-0 flex items-center rounded-xl bg-gradient-to-l from-gray-50 from-[60%] pl-6 pr-4 text-gray-700 opacity-0 group-hover:opacity-100 dark:from-gray-700 dark:text-gray-200"
                            >
                    ...
                    ><span data-projection-id="48" style="opacity: 1; transform: none"
                      ><button
                        class="btn relative btn-neutral group w-full whitespace-nowrap rounded-xl px-4 py-3 text-left text-gray-700 dark:text-gray-300 md:whitespace-normal"
                        as="button"
                      >
                        <div class="flex w-full gap-2 items-center justify-center">
                          <div class="flex w-full items-center justify-between">
                            <div class="flex flex-col overflow-hidden">
                              <div class="truncate">Make a content strategy</div>
                              <div class="truncate font-normal opacity-50">
